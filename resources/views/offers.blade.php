    ...
    <div class="containerOffer">
      <article class="offer">
        <div class="offer__divImg">
          <img class="offer__divImg__img" src="./images/4.webp" alt="habitacion hotel" />
        </div>
        <div class="offer__divPrices">
          <div class="offer__divPrices__old">
            <p class="offer__divPrices__old__number">$500</p>
            <p class="offer__divPrices__old__text">/Night</p>
          </div>
          <div class="offer__divPrices__new">
            <p class="offer__divPrices__new__number">$345</p>
        ...
        <article class="descriptionOffer">
          <div class="descriptionOffer__title">
            ...
            <h1 class="title title--descriptionOffer">Luxury Double Bed</h1>
          </div>
      ...
      <article class="offer">
        <div class="offer__divImg">
          <img class="offer__divImg__img" src="./images/3.webp" alt="habitacion hotel" />
        </div>
        <div class="offer__divPrices">
          <div class="offer__divPrices__old">
            <p class="offer__divPrices__old__number">$500</p>
      ...
      <article class="offer">
        <div class="offer__divImg">
          <img class="offer__divImg__img" src="./images/2.webp" alt="habitacion hotel" />
        </div>
        <div class="offer__divPrices">
          <div class="offer__divPrices__old">
            <p class="offer__divPrices__old__number">$500</p>
      ...
      <article class="offer">
        <div class="offer__divImg">
          <img class="offer__divImg__img" src="./images/1.webp" alt="habitacion hotel" />
        </div>
        <div class="offer__divPrices">
          <div class="offer__divPrices__old">
            <p class="offer__divPrices__old__number">$500</p>
