...
<body>
  ...
  <section class="containerInfo">
    <div class="info">
      ...
      <p class="info__title info--titleSmall">Ultimate Rooms</p>
      <nav class="breadcrumb">
        <a class="breadcrumb__link" href="/">Home</a>
        <span class="breadcrumb__divider"> | </span>
        <p class="breadcrumb__pageActual">Rooms</p>
      </nav>
    </div>
  </section>
  <section class="roomsPage">
    <div class="CardContainer">
      <article class="roomcard">
        <img class="roomcard__img" src="./images/1.webp" alt="habitacion hotel" />
      ...
      <article class="roomcard">
        <img class="roomcard__img" src="./images/2.webp" alt="habitacion hotel" />
        <div class="roomcard__icons">
          <img src="./svg/bed.svg" alt="bed" />
          <img src="./svg/wifi.svg" alt="wifi" />
          <img src="./svg/car.svg" alt="car" />
      ...
      <article class="roomcard">
        <img class="roomcard__img" src="./images/3.webp" alt="habitacion hotel" />
        <div class="roomcard__icons">
          <img src="./svg/bed.svg" alt="bed" />
          <img src="./svg/wifi.svg" alt="wifi" />
          <img src="./svg/car.svg" alt="car" />
